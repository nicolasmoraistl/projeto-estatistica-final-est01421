...
#trazer base csv
database_main = pd.read_csv('data-transform/data_frame_en.csv', sep=',')

database_main['corruption_control'] = pd.NA

database_main['foreign_investments'] = pd.NA

database_main['economic_growth'] = pd.NA
...
#expectativa de vida
life_expectancy = pd.read_csv('data-transform/data/life_expect/API_SP.DYN.LE00.IN_DS2_EN_csv_v2_257577.csv')

database_main = transfer_data_to_main(life_expectancy, 'life_expectancy', database_main)

database_main.to_csv('data-transform/main_database.csv', index=False)

#porcentagem da taxação no PIB

tax_revenue = pd.read_csv('data-transform/data/Tax-revenue/API_GC.TAX.TOTL.GD.ZS_DS2_en_csv_v2_1167.csv')
...
unemployement = pd.read_csv('data-transform/data/Unemployement/API_SL.UEM.TOTL.ZS_DS2_en_csv_v2_115692.csv')
...
gdp_ppp = pd.read_csv('data-transform/data/gdp_ppp_percapita/API_NY.GDP.PCAP.PP.CD_DS2_en_csv_v2_396610.csv')
...
eco_growth = pd.read_csv('data-transform/data/economic_growth/API_NY.GDP.MKTP.KD.ZG_DS2_en_csv_v2_443095.csv')

database_main = transfer_data_to_main(eco_growth, 'economic_growth', database_main)

database_main.to_csv('data-transform/main_database.csv', index=False)
#participação da indústria no PIB

industry_share = pd.read_csv('data-transform/data/value-added-industry/API_NV.IND.MANF.ZS_DS2_en_csv_v2_448973.csv')
...
oil_share_gdp = pd.read_csv('data-transform/data/Oil_Share_GDP/API_NY.GDP.PETR.RT.ZS_DS2_en_csv_v2_2051.csv')
...
fdi_gdp = pd.read_csv('data-transform/data/foreign_direct_investments/API_BX.KLT.DINV.WD.GD.ZS_DS2_en_csv_v2_411706.csv')
...
inflation_index = pd.read_csv('data-transform/data/Inflation_index/API_FP.CPI.TOTL.ZG_DS2_en_csv_v2_250039.csv')
...
fuel_exports = pd.read_csv('data-transform/data/%fuel exports-merchandise/API_TX.VAL.FUEL.ZS.UN_DS2_en_csv_v2_1353.csv')
...
hdi_index = pd.read_csv('data-transform/data/HDI/hdr_data.csv')
...
gov_eff = pd.read_csv('data-transform/data/governement_effectiveness_indexes/3be8611c-a998-4ed7-ad29-16f485b87ebf_Data.csv')
...
df_resources = pd.read_csv('data-transform/data/development-revenue/world-imf2026.csv')
